...
<section class="notice">
    ...
    <p>Here, you can select which fields are hidden/visible/mandatory when filling out forms, and which are visible in any results (providing a value exists for the given field).</p>
</section>
