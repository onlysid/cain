...
<section class="notice">
    ...
    <p>Log a QC test for the instrument with the following serial number: <?= $instrument['serial_number'];?><?= $instrument['module_name'] ? ' (' . $instrument['module_name'] . ')' : '';?>.</p>
</section>
    ...
    <div class="form-fields">
        <div class="field">
            ...
            <div class="input-wrapper">
                ...
                <input id="dateTimePicker" name="datetime" class="date-time-picker-no-future" type="text" placeholder="<?= gmdate("Y-m-d H:i");?>" value="<?= gmdate("Y-m-d H:i");?>" readonly/>
            </div>
        </div>
    </div>
