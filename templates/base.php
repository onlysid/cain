        ...
        <div id="notices">
            <?php foreach(Session::getNotices() as $notice) : 
                ...
                <div class="notice <?= $severity;?>">
                    <div class="rounded-full group transition-all duration-500 hover:scale-110 p-0.5 bg-black shadow-xl shadow-dark/50 absolute top-0 right-0 translate-x-1/4 -translate-y-1/4">
